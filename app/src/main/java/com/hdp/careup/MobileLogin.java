...
//                    removing first 0 from the mobile number
                    char[] numbs = mobile.getText().toString().toCharArray();
                    if(numbs[0] == '0'){
                    ...
                    transaction.replace(R.id.login_fragment_container, new GetOtp(spinner.getSelectedItem().toString()+mobileNo), "GET_OTP");
                    transaction.commit();
                }else{
